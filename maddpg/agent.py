...
class Agent:
    ...
    def __init__(self,
        ...
        # when the simulation starts we want to copy
        # the parameters of our online networks to our target networks
        # tau = 1 (completely copy)
    ...
    def choose_action(self, observation):
        ...
        # We can test with different noise algorithms
        # I can test the noise class that we used in DDPG
